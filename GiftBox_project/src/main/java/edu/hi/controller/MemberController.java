...
import edu.hi.service.MemberService;
...
//		logger.info("join Service 성공");
        ...
        encodePw = crypt.encode(rawPw);        // 비밀번호 인코딩
...
//        return "redirect:/main";
        ...
        if(lvo != null) {            // 일치하는 아이디 존재시
            ...
            if(true == crypt.matches(rawPw, encodePw)) {        // 비밀번호 일치여부 판단
    ...
    public void logoutPOST(HttpServletRequest request) throws Exception{
        ...
        session.invalidate();  //"invalidate()" 메서드의 경우 세션 전체를 무효화하는 메서드
