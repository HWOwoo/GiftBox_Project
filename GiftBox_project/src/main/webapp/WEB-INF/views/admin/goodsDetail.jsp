...
<body>
                    ...
                    <div class="admin_content_main">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="giftName" value="<c:out value="${goodsInfo.giftName}"/>" disabled>
                    			</div>
                    		</div>
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input id="shopName_input" readonly="readonly" value="${goodsInfo.shopName }" disabled>
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="giftPrice" value="<c:out value="${goodsInfo.giftPrice}"/>" disabled>
                    			</div>
                    		</div>               
                    		<div class="form_section">
                    			<div class="form_section_title">
                    			...
                    			<div class="form_section_content">
                    				<input name="giftStock" value="<c:out value="${goodsInfo.giftStock}"/>" disabled>
                    			</div>
                    		</div>          
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content bit">
                    				<textarea name="giftIntro" id="giftIntro_textarea" disabled>${goodsInfo.giftIntro}</textarea>
                    			</div>
                    		</div>        		
                    		<div class="form_section">
                    			<div class="form_section_title">
	...
	<script>
		...
		$(document).ready(function(){
			...
			/* 할인율 값 삽입 */
			let giftDiscount = '<c:out value="${goodsInfo.giftDiscount}"/>' * 100;
			$("#discount_interface").attr("value", giftDiscount);
		...
		$("#modifyBtn").on("click", function(e){
			e.preventDefault();
			let addInput = '<input type="hidden" name="giftId" value="${goodsInfo.giftId}">';
