                    ...
                    <div class="goods_table_wrap">
	                    ...
	                    <c:if test="${listcheck != 'empty'}">
	                    	<table class="goods_table">
	                    		...
	                    		<tr>
	                    			<td><c:out value="${list.giftId}"></c:out></td>
	                    			<td>
	                    				<a class="move" href='<c:out value="${list.giftId}"/>'>
										<c:out value="${list.giftName}"></c:out></a>
									</td>
	                    			<td><c:out value="${list.shopName}"></c:out></td>
	                    			<td><c:out value="${list.cateName}"></c:out></td>
	                    			<td><c:out value="${list.giftStock}"></c:out></td>
...
<script>
	...
	$(".move").on("click", function(e){
		...
		moveForm.append("<input type='hidden' name='giftId' value='"+$(this).attr("href") + "'>");
